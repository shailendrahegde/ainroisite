# The Tipping Point For Habit Formation
...
## How to Fast-Track Users to 15 Actions a Week

### High-Intensity Experiences

This is where structured, high-intensity experiences matter. Events like **"promptathons"** or **hands-on labs**, where users perform 15–20 guided actions within a focused 30–60 minute window, can dramatically accelerate their journey to habit.

You are not just teaching features—you are **giving people a lived experience of AI actually helping them get work done**.

### Prioritize Low-Friction Surfaces

When it comes to enablement, prioritize **low-friction, familiar surfaces** such as:
- **Meeting platforms** - automated notes, summaries, action items
- **Chat interfaces** - Q&A, quick lookups, enterprise knowledge

These surfaces have minimal barriers to trying AI and the payoff is obvious.

### Be Selective About Complex Tools

Be more selective about leading with spreadsheets or design tools. These often have:
- Narrower applicability
- Tighter constraints on what counts as an "acceptable" output

This can make early experiences feel **brittle instead of empowering**.

---

**Bottom line:** Focus on getting users to 15 actions per week as quickly as possible through structured experiences and easy-to-use surfaces. This is where experimentation becomes habit, and habit becomes value.
