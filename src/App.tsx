    ...
    <div className="min-h-screen bg-background text-foreground">
      <div className="container mx-auto px-4 pt-8 pb-12 md:px-8 md:pt-12 md:pb-16 lg:px-16 lg:pt-16 lg:pb-20 max-w-[1600px]">
        <Tabs defaultValue="insights" className="w-full">
          <TabsList className="mb-40 md:mb-36 h-12 px-2 gap-6">
          ...
          </TabsList>          <TabsContent value="insights" className="mt-16 md:mt-20 lg:mt-24">
            {selectedArticle ? (
          ...
          <TabsContent value="projects" className="mt-16 md:mt-20 lg:mt-24">
          ...
          <TabsContent value="about" className="mt-16 md:mt-20 lg:mt-24">
            <div className="max-w-4xl mx-auto">
              <div className="mb-12 md:mb-16">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-semibold mb-4 text-foreground">
                  About Us
